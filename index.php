										...
										<table id="best_seller_data_table" class="table">
											...
											<tbody>
												<tr>
													...
													<td>
														<span class="cat">
															...
															<a href="product-list.php">Clothes</a>
															<a href="product-list.php">Phones</a>
														</span>
													</td>
													<td>685</td>
													<td>$1254</td>
												...
												<tr>
													...
													<td>
														<span class="cat">
															<a href="product-list.php">Phone</a>
															<a href="product-list.php">Camera</a>
															<a href="product-list.php">Clothes</a>
															<a href="product-list.php">Phones</a>
														</span>
													</td>
												...
												<tr>
													...
													<td>
														<span class="cat">
															<a href="product-list.php">Laptop</a>
															<a href="product-list.php">Furniture</a>
															<a href="product-list.php">Phones</a>
														</span>
													</td>
													<td>95</td>
												...
												<tr>
													...
													<td>
														<span class="cat">
															<a href="product-list.php">Tools</a>
															<a href="product-list.php">Clothes</a>
															<a href="product-list.php">Bags</a>
														</span>
													</td>
													<td>675</td>
													<td>$3105</td>
												...
												<tr>
													...
													<td>
														<span class="cat">
															<a href="product-list.php">Shoes</a>
															<a href="product-list.php">Clothes</a>
															<a href="product-list.php">Jewellery</a>
														</span>
													</td>
													<td>854</td>
													<td>$3854</td>
								...
								<div class="top-product-table">
									<div class="table-responsive">
										<table id="top_product_data_table" class="table">
											...
											<tbody>
												<tr>
													<td><img class="cat-thumb" src="https://diamu.com.bd/wp-content/uploads/2023/05/Mens-Premium-Contemporary-T-Shirt-Brick-Grey.jpg"
